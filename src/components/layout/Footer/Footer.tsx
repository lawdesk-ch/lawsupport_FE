    ...
    <footer className="bg-[#fafafa] mt-20 lg:mt-25">
      ...
      <div className="container-mobile pb-5 lg:pb-13 pt-20 lg:pt-10 w-full">
        <div className="flex flex-col md:flex-row w-full md:justify-between">
          <div className="lg:flex md:w-auto lg:w-full lg:gap-0 lg:max-w-[907px] lg:justify-between mb-10 md:mb-0">
            <section className="mb-10 lg:mb-0">
              <h3 className="text-xs max-w-[345] md:max-w-[354px] lg:max-w-[429px] mb-[30px] lg:mb-[125px] color-silver">
              ...
              <div className="flex flex-col gap-2">
                <p className="text-xs color-silver">
                ...
                {pathname === '/' ? (
                  <div className="flex items-center gap-4 w-[443px]">
                    ...
                    <div className="flex flex-col">
                      <span className="text-4xl font-medium uppercase color-red">
                        Law support
                      </span>
                  ...
                  <Link
                    href="/"
                    className="text-6xl md:text-[77px] m-0 p-0 leading-none color-red"
                  >
                    <div className="flex items-center gap-4 w-[443px]">
                      <Image
                        src="/images/logo.png"
            ...
            <section className="flex md:gap-6 lg:gap-0 lg:w-full md:max-w-[364px] lg:max-w-[409px] justify-between">
              ...
              <nav className="flex flex-col md:w-[200px] gap-[14px]">
          ...
          <section className="flex flex-col gap-[11px] w-full lg:w-auto lg:flex-1 lg:max-w-[422px] items-end ml-auto md:ml-0 justify-end lg:mb-1">
            <address className="flex w-full justify-between">
              <p className="text-xs color-silver">
                Switzerland
                <br />
            ...
            <div className="flex justify-between md:gap-4 lg:gap-0 w-full items-center">
              <ul className="flex justify-between w-full lg:w-auto lg:flex-1 max-w-[176px] text-xs color-red">
              ...
              <button
                ...
                className="bg-black text-white rounded text-xs flex-1 min-w-[120px] max-w-[177px] h-8 cursor-pointer active:bg-[#6a6a6a] hover:bg-[#6a6a6a]"
              >
                Order a callback
              </button>
            </div>
